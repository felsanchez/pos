...
class imprimirDetalleFactura
{
    ...
    public function traerImpresionDetalle()
    {
        ...
        if (!empty($venta["notes"])) {
            $htmlLeft .= '<div class="lead">Notas del cliente:</div><div class="well">' . $venta["notes"] . '</div>';
        }
...
if (isset($_GET["idVenta"])) {
    $imprimir = new imprimirDetalleFactura();
