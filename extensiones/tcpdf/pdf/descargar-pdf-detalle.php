...
class imprimirDetalleVenta
{
    ...
    public function traerImpresionDetalle()
    {
        ...
        // Ahora el cursor está después de Notas/Obs. Dibujamos el título del QR
        ...
        if (!empty($venta["qr_data"])) {
            ...
            if (!empty($cufeDisp)) {
                ...
                $pdf->MultiCell(105, 0, $cufeDisp, 1, 'L', true, 1, 12, '', true);
            }
        }
