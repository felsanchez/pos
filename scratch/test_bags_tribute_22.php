...
// Prepare payload with tribute_id = 22
$payload = [
    "numbering_range_id" => 1190,
    "reference_code" => "TEST-BAGS-22-" . time(),
    "observation" => "Prueba de bolsas con tribute_id = 22",
    "payment_form" => "1",
    ...
    "items" => [
        [
            ...
            "standard_code_id" => 1,
            "is_excluded" => 0,
            "tribute_id" => 22, // Try 22 instead of 11
            "withholding_taxes" => []
        ]
    ]
];

echo "=== SENDING PAYLOAD WITH tribute_id = 22 ===\n";
