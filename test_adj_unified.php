...
$payload = [
    ...
    "type_document_id" => 12,     // Nota de ajuste del documento soporte
    "reference_code" => "NA-TEST-" . time(),
    "billing_reference" => [
        "number" => $originalNumber,
        "uuid" => $originalUUID,
        "issue_date" => $originalDate
    ],
    "customer" => [ // Provider data mapped to Customer structure
    ...
    "observation" => "Prueba de anulación via bills/validate",
    "payment_form" => "1",
