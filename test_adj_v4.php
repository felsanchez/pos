...
// Bill ID 472 from previous DS emission
$billId = 472;
...
$payload = [
    ...
    "reference_code" => "NA-TEST-NC-V4-" . time(),
    "billing_reference" => [
    ...
    "correction_concept_code" => "2", // Added based on 422 error
    "observation" => "Prueba v4 via credit-notes/validate",
    "payment_form" => "1",
    ...
    "items" => [
        [
            ...
            "unit_measure_id" => 70,
            "standard_code_id" => 1,
            "is_excluded" => 0, // Set to 0 to avoid IVA error
            "tribute_id" => 7
        ]
    ]
];
